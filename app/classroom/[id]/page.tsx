            ...
            <div className="min-h-screen bg-background text-foreground">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="mt-0.5 text-sm text-muted-foreground">
                                    {room?.subject} · {modules?.length} modules · Prof. {teacher?.name}
                                </p>
                            </div>
                        </div>
                ...
                <div className="mx-auto max-w-5xl px-6 py-6">
                    <div className="mb-8 grid grid-cols-3 gap-4">
                        {[
                            { icon: Layers, label: "Total Modules", value: modules?.length },
                            { icon: FileText, label: "Documents", value: modules?.length },
                        ...
                        {modules?.map((mod, idx) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`
                  group w-full rounded-2xl border p-5 text-left transition-all duration-200 cursor-pointer ${color.border} ${color.bg} hover:scale-[1.005] hover:shadow-md`
                                    }
                                >
